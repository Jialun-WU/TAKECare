...
def med_process(med_file):
    ...
    # 删除不需要的列
    med_pd.drop(columns=[
        'pharmacy_id', 'poe_id', 'poe_seq', 'order_provider_id', 'stoptime',
        'drug_type', 'drug', 'formulary_drug_cd', 'gsn', 'prod_strength',
...
def diag_process(diag_file):
    ...
    # Rename columns to match the original logic
    diag_pd.rename(columns={
        'subject_id': 'SUBJECT_ID',
        'hadm_id': 'HADM_ID',
        'seq_num': 'SEQ_NUM',
        'icd_code': 'ICD9_CODE'
...
def procedure_process(procedure_file):
    ...
    # 保留字段一致性（只保留必要字段）
    pro_pd = pro_pd[['SUBJECT_ID', 'HADM_ID', 'SEQ_NUM', 'ICD9_CODE']]
...
if __name__ == '__main__':
    ...
    med_file = '/Users/jialunwu/Desktop/MIMIC/IV/prescriptions.csv'
    diag_file = '/Users/jialunwu/Desktop/MIMIC/IV/diagnoses_icd.csv'
    procedure_file = '/Users/jialunwu/Desktop/MIMIC/IV/procedures_icd.csv'
